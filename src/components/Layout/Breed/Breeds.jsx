...
import ListBreeds from '../../ListBreeds/ListBreeds';
import ListLimite from '../../ListLimite/ListLimite';
...
const Breeds = () => {
	...
	async function searchByBreed(breed_id) {
		const response = await fetch(`https://api.thecatapi.com/v1/images/search?breed_id=${breed_id}`, {
			method: 'GET',
			headers: {
				'Content-Type': 'application/json',
				'Authorization': `Bearer ${API}`,
